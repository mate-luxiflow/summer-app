...
// ── Tab icon definitions (stable, key-based) ───────────────────────────────────
const TAB_ICONS = {
  dashboard: active => (
...
const TAB_KEYS = ['dashboard', 'routine', 'stats', 'store', 'settings']
const TAB_I18N = {
  dashboard: 'tabGrind',
  routine:   'tabRoutine',
  stats:     'tabStats',
...
export default function App() {
  ...
  // Software keyboard detection — hide fixed nav while typing
  useEffect(() => {
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {activeTab === 'store'     && <ComingSoon label={t('tabStore')} />}
